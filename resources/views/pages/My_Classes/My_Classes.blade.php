    ...
    <div class="card card-statistics h-100">
        <div class="card-body">
            ...
            <br><br>
                ...
                <a class="btn btn-primary" href="{{ route("Classrooms.index") }}">{{ trans("My_Classes_trans.Show_all") }}</a>
                </form>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#"
                                       ...
                                       data-toggle="modal"
                                       data-target="#edit{{ $My_Class->id }}">{{ trans('Sections_trans.Edit') }}</a>
                                    <a href="#"
                                       class="btn btn-outline-danger btn-sm"
                                       data-toggle="modal"
                                       data-target="#delete{{ $My_Class->id }}">{{ trans('Sections_trans.Delete') }}</a>
                                </td>
                            </tr>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control form-control-lg"
                                                            ...
                                                            <option disabled selected>
                                                                {{ trans("My_Classes_trans.Choose The Class") }}
                                                            </option>
                                                            @foreach ($Grades as $Grade)
